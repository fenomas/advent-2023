var N7=Object.defineProperty;var w7=(n,e,J)=>e in n?N7(n,e,{enumerable:!0,configurable:!0,writable:!0,value:J}):n[e]=J;var b7=(n,e,J)=>(w7(n,typeof e!="symbol"?e+"":e,J),J);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const F of document.querySelectorAll('link[rel="modulepreload"]'))s(F);new MutationObserver(F=>{for(const L of F)if(L.type==="childList")for(const r of L.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function J(F){const L={};return F.integrity&&(L.integrity=F.integrity),F.referrerPolicy&&(L.referrerPolicy=F.referrerPolicy),F.crossOrigin==="use-credentials"?L.credentials="include":F.crossOrigin==="anonymous"?L.credentials="omit":L.credentials="same-origin",L}function s(F){if(F.ep)return;F.ep=!0;const L=J(F);fetch(F.href,L)}})();function L7(){}function M7(n){return n()}function j7(){return Object.create(null)}function y(n){n.forEach(M7)}function A7(n){return typeof n=="function"}function y7(n,e){return n!=n?e==e:n!==e||n&&typeof n=="object"||typeof n=="function"}function O7(n){return Object.keys(n).length===0}function v(n,e){n.appendChild(e)}function h7(n,e,J){n.insertBefore(e,J||null)}function i7(n){n.parentNode&&n.parentNode.removeChild(n)}function C7(n,e){for(let J=0;J<n.length;J+=1)n[J]&&n[J].d(e)}function T(n){return document.createElement(n)}function l7(n){return document.createTextNode(n)}function q(){return l7(" ")}function H(n,e,J,s){return n.addEventListener(e,J,s),()=>n.removeEventListener(e,J,s)}function c(n,e,J){J==null?n.removeAttribute(e):n.getAttribute(e)!==J&&n.setAttribute(e,J)}function $7(n){return Array.from(n.childNodes)}function m7(n,e){e=""+e,n.data!==e&&(n.data=e)}function Y(n,e){n.value=e??""}function E7(n,e,J,s){J==null?n.style.removeProperty(e):n.style.setProperty(e,J,s?"important":"")}function V(n,e,J){n.classList.toggle(e,!!J)}let K7;function d7(n){K7=n}const e7=[],_7=[];let J7=[];const z7=[],Z7=Promise.resolve();let T7=!1;function I7(){T7||(T7=!0,Z7.then(H7))}function x7(n){J7.push(n)}const c7=new Set;let n7=0;function H7(){if(n7!==0)return;const n=K7;do{try{for(;n7<e7.length;){const e=e7[n7];n7++,d7(e),U7(e.$$)}}catch(e){throw e7.length=0,n7=0,e}for(d7(null),e7.length=0,n7=0;_7.length;)_7.pop()();for(let e=0;e<J7.length;e+=1){const J=J7[e];c7.has(J)||(c7.add(J),J())}J7.length=0}while(e7.length);for(;z7.length;)z7.pop()();T7=!1,c7.clear(),d7(n)}function U7(n){if(n.fragment!==null){n.update(),y(n.before_update);const e=n.dirty;n.dirty=[-1],n.fragment&&n.fragment.p(n.ctx,e),n.after_update.forEach(x7)}}function W7(n){const e=[],J=[];J7.forEach(s=>n.indexOf(s)===-1?e.push(s):J.push(s)),J.forEach(s=>s()),J7=e}const Y7=new Set;function n1(n,e){n&&n.i&&(Y7.delete(n),n.i(e))}function v7(n){return n?.length!==void 0?n:Array.from(n)}function e1(n,e,J){const{fragment:s,after_update:F}=n.$$;s&&s.m(e,J),x7(()=>{const L=n.$$.on_mount.map(M7).filter(A7);n.$$.on_destroy?n.$$.on_destroy.push(...L):y(L),n.$$.on_mount=[]}),F.forEach(x7)}function J1(n,e){const J=n.$$;J.fragment!==null&&(W7(J.after_update),y(J.on_destroy),J.fragment&&J.fragment.d(e),J.on_destroy=J.fragment=null,J.ctx=[])}function L1(n,e){n.$$.dirty[0]===-1&&(e7.push(n),I7(),n.$$.dirty.fill(0)),n.$$.dirty[e/31|0]|=1<<e%31}function F1(n,e,J,s,F,L,r=null,t=[-1]){const d=K7;d7(n);const l=n.$$={fragment:null,ctx:[],props:L,update:L7,not_equal:F,bound:j7(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(d?d.$$.context:[])),callbacks:j7(),dirty:t,skip_bound:!1,root:e.target||d.$$.root};r&&r(l.root);let g=!1;if(l.ctx=J?J(n,e.props||{},(i,o,...u)=>{const b=u.length?u[0]:o;return l.ctx&&F(l.ctx[i],l.ctx[i]=b)&&(!l.skip_bound&&l.bound[i]&&l.bound[i](b),g&&L1(n,i)),o}):[],l.update(),g=!0,y(l.before_update),l.fragment=s?s(l.ctx):!1,e.target){if(e.hydrate){const i=$7(e.target);l.fragment&&l.fragment.l(i),i.forEach(i7)}else l.fragment&&l.fragment.c();e.intro&&n1(n.$$.fragment),e1(n,e.target,e.anchor),H7()}d7(d)}class r1{constructor(){b7(this,"$$");b7(this,"$$set")}$destroy(){J1(this,1),this.$destroy=L7}$on(e,J){if(!A7(J))return L7;const s=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return s.push(J),()=>{const F=s.indexOf(J);F!==-1&&s.splice(F,1)}}$set(e){this.$$set&&!O7(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}const t1="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(t1);var s1=[54304,54418,142,,,281];function l1(n=""){return n.split(/\n/).reduce((e,J)=>{var s=J.split("").filter(F=>/\d/.test(F));return e+parseInt(s[0]+s.at(-1))||0},0)}function d1(n=""){var e=[..."0123456789".split(""),"zero","one","two","three","four","five","six","seven","eight","nine"];return n.split(/\n/).reduce((J,s)=>{var F=-1,L=1/0,r=-1,t=-1;return e.forEach((d,l)=>{var g=s.indexOf(d);g>-1&&g<L&&(L=g,F=l%10);var i=s.lastIndexOf(d);i>-1&&i>t&&(t=i,r=l%10)}),J+parseInt(F+""+r)},0)}const i1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:s1,part1:l1,part2:d1},Symbol.toStringTag,{value:"Module"}));var g1=[2727,56580,8,2286];function o1(n=""){var e=0,J={red:12,green:13,blue:14};return n.split(`
`).forEach(s=>{var[F,L]=s.split(":"),r=L.split(";").every(t=>t.split(",").every(d=>{var[,l,g]=/(\d+)\s+(\S+)/.exec(d);return J[g]?parseInt(l)<=J[g]:!0}));r&&(e+=parseInt(/\d+/.exec(F)[0]))}),e}function f1(n=""){var e=0;return n.split(`
`).forEach(J=>{var s={red:0,green:0,blue:0},[,F]=J.split(":");F.split(";").forEach(L=>{L.split(",").forEach(r=>{var[,t,d]=/(\d+)\s+(\S+)/.exec(r),l=parseInt(t);l>s[d]&&(s[d]=l)})}),e+=s.red*s.green*s.blue}),e}const v1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:g1,part1:o1,part2:f1},Symbol.toStringTag,{value:"Module"}));var u1=[539637,82818007,4361,467835];function h1(n=""){var e=[],J=[];n.split(`
`).forEach((F,L)=>{e[L]=[],J[L]=[];for(var r=0;r<F.length;r++){var t=F[r];if(t!==".")if(/\d/.test(t)){var d=parseInt(F.substring(r)),l=String(d).length;e[L].push({y:L,x:r,value:d,len:l}),r+=l-1}else J[L].push({y:L,x:r})}});var s=0;return e.forEach(F=>{F.forEach(L=>{for(var r=L.y-1;r<L.y+2;r++){var t=J[r]||[],d=t.some(l=>{if(!(l.x<L.x-1)&&!(l.x>L.x+L.len))return!0});if(d){s+=L.value;return}}})}),s}function a1(n=""){var e=[],J=[];n.split(`
`).forEach((F,L)=>{e[L]=[],J[L]=[];for(var r=0;r<F.length;r++){var t=F[r];if(t!==".")if(/\d/.test(t)){var d=parseInt(F.substring(r)),l=String(d).length;e[L].push({y:L,x:r,value:d,len:l}),r+=l-1}else t==="*"&&J[L].push({y:L,x:r})}});var s=0;return J.forEach(F=>{F.forEach(L=>{for(var r=0,t=1,d=L.y-1;d<L.y+2;d++){var l=e[d]||[];l.forEach(g=>{L.x<g.x-1||L.x>g.x+g.len||(r++,t*=g.value)})}r===2&&(s+=t)})}),s}const b1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:u1,part1:h1,part2:a1},Symbol.toStringTag,{value:"Module"}));var c1=[26443,6284877,13,30];function p1(n=""){var e=0;return n.split(`
`).forEach((J,s)=>{var F=J.split(":")[1].split("|"),L=F[0].trim().split(/\s+/).map(d=>parseInt(d)),r=F[1].trim().split(/\s+/).map(d=>parseInt(d)),t=r.reduce((d,l)=>d+(L.includes(l)?1:0),0);t>0&&(e+=Math.pow(2,t-1))}),e}function m1(n=""){var e=n.split(`
`).map((F,L)=>{var r=F.split(":")[1].split("|"),t=r[0].trim().split(/\s+/).map(g=>parseInt(g)),d=r[1].trim().split(/\s+/).map(g=>parseInt(g)),l=d.reduce((g,i)=>g+(t.includes(i)?1:0),0);return l>0&&(J+=Math.pow(2,l-1)),l}),J=0,s=[];return e.forEach((F,L)=>{for(var r=1+(s[L]||0),t=e[L],d=0;d<t;d++){var l=L+1+d;s[l]=(s[l]||0)+r}J+=r}),J}const T1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:c1,part1:p1,part2:m1},Symbol.toStringTag,{value:"Module"}));var x1=[525792406,79004094,35,46];function K1(n=""){var e=[],J=null;n.split(`
`).forEach((F,L)=>{if(/:/.test(F)){var[,r]=F.split(":");e.push(J=[]),F=r}var t=F.trim().split(/\s+/).filter(d=>d).map(d=>parseInt(d));t.length>0&&J.push(t)});var s=e.shift()[0];return e.forEach(F=>{var L={};F.forEach(([r,t,d])=>{s.forEach((l,g)=>{L[g]||l>=t&&l<t+d&&(s[g]+=r-t,L[g]=!0)})})}),s.reduce((F,L)=>Math.min(F,L),1/0)}function Q1(n=""){var e,J=[],s;n.split(`
`).forEach((t,d)=>{if(/:/.test(t)){var[,l]=t.split(":");if(!e){e=l.trim().split(/\s+/).map(u=>parseInt(u));return}J.push(s=[]),t=l}if(t=t.trim(),!!t){var[g,i,o]=t.split(/\s+/).map(u=>parseInt(u));s.push([i,i+o,g-i])}}),J.forEach(t=>{t.sort((d,l)=>d[0]-l[0])});for(var F=1/0,L=(t,d,l=0)=>{if(l>=J.length){t<F&&(F=t);return}var g=J[l];g.some(([i,o,u])=>{if(!(t>=o)){if(d<=i)return!0;t<i&&(L(t,i,l+1),t=i);var b=Math.min(d,o);L(t+u,b+u,l+1),t=b}}),t<d&&L(t,d,l+1)},r=0;r<e.length;r+=2)L(e[r],e[r]+e[r+1]);return F}const k1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:x1,part1:K1,part2:Q1},Symbol.toStringTag,{value:"Module"}));var j1=[1195150,42550411,288,71503];function X7(n=""){var e=n.split(`
`).map(L=>{var r=L.split(":")[1];return r.trim().split(/\s+/).map(t=>parseInt(t))}),[J,s]=e,F=1;return J.forEach((L,r)=>{var t=-L,d=s[r],l=Math.sqrt(t*t-4*d),g=(-t-l)/2,i=(-t+l)/2,o=1e-5,u=Math.floor(i-o)-Math.ceil(g+o)+1;F*=u}),F}function C1(n=""){return X7(n.replace(/ /g,""))}const _1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:j1,part1:X7,part2:C1},Symbol.toStringTag,{value:"Module"}));var z1=[249726565,251135960,6440,5905];function q1(n=""){var e="23456789TJQKA".split(""),J={};e.forEach((F,L)=>{J[F]=String.fromCharCode(65+L)});var s=n.split(`
`).map(F=>{var[L,r]=F.trim().split(/\s+/),t=parseInt(r),d=L.split("").map(i=>J[i]),l={};d.forEach(i=>{l[i]=(l[i]||0)+1});var g=Object.keys(l).map(i=>l[i]).sort((i,o)=>o-i);return g.push(0,0),{chars:d,bid:t,ctList:g}});return s.sort((F,L)=>{for(var r=0;r<2;r++)if(F.ctList[r]!==L.ctList[r])return F.ctList[r]-L.ctList[r];for(var t=0;t<5;t++){var d=F.chars[t],l=L.chars[t];if(d!==l)return d>l?1:-1}return 0}),s.reduce((F,{bid:L},r)=>F+L*(r+1),0)}function R1(n=""){var e="J23456789TQKA".split(""),J={};e.forEach((F,L)=>{J[F]=String.fromCharCode(65+L)});var s=n.split(`
`).map(F=>{var[L,r]=F.trim().split(/\s+/),t=parseInt(r),d=L.split("").map(o=>J[o]),l={},g=0;d.forEach(o=>{if(o==="A"){g++;return}l[o]=(l[o]||0)+1});var i=Object.keys(l).map(o=>l[o]).sort((o,u)=>u-o);return i.push(0,0),i[0]+=g,{chars:d,bid:t,ctList:i,hand:L}});return s.sort((F,L)=>{for(var r=0;r<2;r++)if(F.ctList[r]!==L.ctList[r])return F.ctList[r]-L.ctList[r];for(var t=0;t<5;t++){var d=F.chars[t],l=L.chars[t];if(d!==l)return d>l?1:-1}return 0}),s.reduce((F,{bid:L},r)=>F+L*(r+1),0)}const G1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:z1,part1:q1,part2:R1},Symbol.toStringTag,{value:"Module"}));var B1=[18673,17972669116327,2,,6,,,6];function S1(n=""){var e={},J=n.split(`
`).map(t=>{if(t=t.trim(),!!t){if(!t.includes("="))return t.split("");var[,d,l,g]=/(\S+) = \((\S+), (\S+)\)/.exec(t);e[d]={L:l,R:g}}}),s=J.shift(),F="AAA";if(!e[F])return-1;for(var L=0,r=0;L<1e7;L++){if(F==="ZZZ")return L;F=e[F][s[r]],r=(r+1)%s.length}return-1}function D1(n=""){var e={},J=[],s={},F=n.split(`
`).map(g=>{if(g=g.trim(),!!g){if(!g.includes("="))return g.split("");var[,i,o,u]=/(\S+) = \((\S+), (\S+)\)/.exec(g);/..A/.test(i)&&J.push(i),/..Z/.test(i)&&(s[i]=!0),e[i]={L:o,R:u}}}),L=F.shift(),r=J.map(g=>{for(var i=0,o=0;i<1e7;i++){if(g in s)return i;g=e[g][L[o]],o=(o+1)%L.length}});r.sort((g,i)=>g-i);for(var t=r.pop();r.length>0;)for(var d=t,l=r.pop();t%l!==0;)t+=d;return t}const M1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:B1,part1:S1,part2:D1},Symbol.toStringTag,{value:"Module"}));var A1=[1772145754,867,114,2];function H1(n=""){var e=(J=[1,1])=>{if(J.length<2)return NaN;for(var s=!0,F=[],L=1;L<J.length;L++){var r=J[L]-J[L-1];s&&(s=r===0),F.push(r)}var t=s?0:e(F);return t+J.at(-1)};return n.split(`
`).reduce((J,s)=>{var F=s.trim().split(/\s+/).map(L=>parseInt(L));return J+=e(F)},0)}function X1(n=""){var e=(J=[1,1])=>{if(J.length<2)return NaN;for(var s=!0,F=[],L=1;L<J.length;L++){var r=J[L]-J[L-1];s&&(s=r===0),F.push(r)}var t=s?0:e(F);return J[0]-t};return n.split(`
`).reduce((J,s)=>{var F=s.trim().split(/\s+/).map(L=>parseInt(L));return J+=e(F)},0)}const V1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:A1,part1:H1,part2:X1},Symbol.toStringTag,{value:"Module"}));var P1=[6757,523,8,,,10];function V7(n=""){var e=[],J=[0,0];n.split(`
`).forEach((d,l)=>{e[l]=[],d.trim().split("").forEach((g,i)=>{g==="S"&&(J=[l,i]),e[l].push({x:i,y:l,char:g})})},0);var s=e.length,F=e[0].length,L=(d,l)=>d<0||d>=s||l<0||l>=F?null:e[d][l],r=L(...J),t=(d,l,g)=>{var i=L(d,l);if(i)for(var o=[i],u=0,b=(Q,m,R)=>{var _=L(Q,m);_&&g(p,_,R)&&o.push(_)};o.length>0&&u++<1e6;){var p=o.pop();b(p.y-1,p.x,0),b(p.y+1,p.x,2),b(p.y,p.x+1,1),b(p.y,p.x-1,3)}};return{start:r,sx:F,sy:s,getAt:L,flood:t}}function N1(n=""){var{start:e,sx:J,sy:s,getAt:F,flood:L}=V7(n),r={"|":[0,2],"-":[1,3],L:[0,1],J:[0,3],7:[2,3],F:[1,2],S:[0,1,2,3]},t=0;return L(e.y,e.x,(d,l,g)=>{if(d.seen=!0,l.seen)return!1;var i=r[d.char]||[];if(!i.includes(g))return!1;var o=r[l.char]||[],u=(g+2)%4;return o.includes(u)?(t++,!0):!1}),t/2}function w1(n=""){var{start:e,sx:J,sy:s,getAt:F,flood:L}=V7(n),r={"|":[0,2],"-":[1,3],L:[0,1],J:[0,3],7:[2,3],F:[1,2],S:[0,1,2,3]},t=[],d=[],l=(o,u,b,p)=>{b%2===0&&(o+=b-1),b%2===1&&(u+=2-b);var Q=F(o,u);Q&&!Q.seen&&p.push(Q)};L(e.y,e.x,(o,u,b)=>{if(o.seen=!0,u.seen)return!1;var p=r[o.char]||[];if(!p.includes(b))return!1;var Q=r[u.char]||[];if(!Q.includes((b+2)%4))return!1;if(o===e)return!0;for(var m=p[(p.indexOf(b)+1)%2],R=d,_=1;_<4;_++){var X=(b+_)%4;if(X===m){R=t;continue}l(o.y,o.x,X,R)}return!0});var g=o=>{var u=0,b=!1;return o.forEach(p=>{p.seen||L(p.y,p.x,(Q,m)=>{if(Q.seen)return!1;Q.seen=!0,u++;var{y:R,x:_}=Q;return(_===0||_===J-1)&&(b=!0),(R===0||R===s-1)&&(b=!0),!m.seen})}),{ct:u,borderSeen:b}},i=g(t);return i.borderSeen&&(i=g(d)),i.ct}const y1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:P1,part1:N1,part2:w1},Symbol.toStringTag,{value:"Module"})),O1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),$1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),E1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),Z1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),I1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),U1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),W1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),Y1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),nn=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),en=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),Jn=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),Ln=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),Fn=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),rn=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),tn=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),sn=`1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet`,ln=`two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
zoneight234
7pqrstsixteen`,dn=`8eight1
98126
...
eight1eighteight8
8four419eighteight1bpv`,gn=`Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`,on=`Game 1: 3 blue, 2 green, 6 red; 17 green, 4 red, 8 blue; 2 red, 1 green, 10 blue; 1 blue, 5 green
...
Game 100: 8 blue, 6 green, 8 red; 7 red, 2 blue; 2 red, 10 green, 10 blue; 9 green, 7 red; 3 red, 7 green, 1 blue`,fn=`467..114..
...*......
..35..633.
......#...
617*......
...
......755.
...$.*....
.664.598..`,vn=`...............776..............552........968..................589...26...........484..............958......186....546.........484.........
.........*.........778....................*....124...................................*...............*........%..26.........................
...
...............764.....................................488.....880.209........416..................183...156..........917...................`,un=`Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53
Card 2: 13 32 20 16 61 | 61 30 68 82 17 32 24 19
Card 3:  1 21 53 59 44 | 69 82 63 72 16 21 14  1
Card 4: 41 92 73 84 69 | 59 84 76 51 58  5 54 83
Card 5: 87 83 26 28 32 | 88 30 70 12 93 22 82 36
Card 6: 31 18 13 56 72 | 74 77 10 23 35 67 36 11`,hn=`Card   1: 79 93 21 74 81 76 17 89  3  5 |  5 67 87 81 76 35 79 21 15 80  8 74 99 28  3 23 19 42 89 16 22 77 92 70 34
...
Card 218: 68 97 66 41 88 16 65 31 23 63 | 29 67 55 64 91  4 12 83  1 40 74 94 58 81 98 82 78 70 26 34 96 14 36 50 56`,an=`seeds: 79 14 55 13
...
60 56 37
56 93 4`,bn=`seeds: 28965817 302170009 1752849261 48290258 804904201 243492043 2150339939 385349830 1267802202 350474859 2566296746 17565716 3543571814 291402104 447111316 279196488 3227221259 47952959 1828835733 9607836
...
2446452559 2629702985 182296534`,cn=`Time:      7  15   30
Distance:  9  40  200`,pn=`Time:        54     94     65     92
Distance:   302   1476   1029   1404`,mn=`32T3K 765
T55J5 684
KK677 28
KTJJT 220
QQQJA 483`,Tn=`88223 818
66JQ9 398
6T9AT 311
53TT3 43
J6266 762
...
22C = (22Z, 22Z)
22Z = (22B, 22B)
XXX = (XXX, XXX)`,kn=`
...
DBP = (RMQ, NMT)
SFT = (PRM, KLH)
CMD = (HFJ, QRF)`,jn=`0 3 6 9 12 15
1 3 6 10 15 21
10 13 16 21 30 45`,Cn=`12 12 11 5 -5 -5 40 194 558 1278 2553 4643 7877 12661 19486 28936 41696 58560 80439 108369 143519
...
5 23 49 86 154 303 625 1278 2553 5048 10072 20498 42428 88236 181828 367312 722717 1380949 2560835 4611894 8077398`,_n=`7-F7-
.FJ|7
SJLL7
|F--J
LJ.LJ`,zn=`FF7FSF7F7F7F7F7F---7
L|LJ||||||||||||F--J
FL-7LJLJ||||||LJL-77
F--JF--7||LJLJ7F7FJ-
L---JF-JLJ.||-FJLJJ7
...
7-L-JL7||F7|L7F-7F7|
L.L7LFJ|||||FJL7||LJ
L7JLJL-JLJLJL--JLJ.L`,qn=`F-|-J7F7F7F-7F7F--7-L|-L7777.FFL-|.|.FF-FF7FFFFF7--F-J7.|-FF77|-F|777-F7.F7FF|-J7|-7.FFJ77FL.7-|-|7.|.77|-F-|-F|-FL.F77.FF-77|7.7--7--7FJ--7
...
LJJ..LL-JJ-L---7J-F77LL.LFJJLL-J-7JJ.L-LL7-L7.LLJL|JJF7-J-JLLJLLJ-7LJJ..LLJ-LJJ.LFL-FJJL|.FLLF-FL|LL.J.FL|-JJ.JJL--JLL--JJ.|J-L|J--J.L7..JJJ`,Rn="",Gn="",Bn="",Sn="",Dn="",Mn="",An="",Hn="",Xn="",Vn="",Pn="",Nn="",wn="",yn="",On="",$n="",En="",Zn="",In="",Un="",Wn="",Yn="",n2="",e2="",J2="",L2="",F2="",r2="",t2="",s2="";var q7=Object.assign({"./advent/day01/solution.js":i1,"./advent/day02/solution.js":v1,"./advent/day03/solution.js":b1,"./advent/day04/solution.js":T1,"./advent/day05/solution.js":k1,"./advent/day06/solution.js":_1,"./advent/day07/solution.js":G1,"./advent/day08/solution.js":M1,"./advent/day09/solution.js":V1,"./advent/day10/solution.js":y1,"./advent/day11/solution.js":O1,"./advent/day12/solution.js":$1,"./advent/day13/solution.js":E1,"./advent/day14/solution.js":Z1,"./advent/day15/solution.js":I1,"./advent/day16/solution.js":U1,"./advent/day17/solution.js":W1,"./advent/day18/solution.js":Y1,"./advent/day19/solution.js":nn,"./advent/day20/solution.js":en,"./advent/day21/solution.js":Jn,"./advent/day22/solution.js":Ln,"./advent/day23/solution.js":Fn,"./advent/day24/solution.js":rn,"./advent/day25/solution.js":tn}),p7=Object.assign({"./advent/day01/input-test.txt":sn,"./advent/day01/input-test2.txt":ln,"./advent/day01/input.txt":dn,"./advent/day02/input-test.txt":gn,"./advent/day02/input.txt":on,"./advent/day03/input-test.txt":fn,"./advent/day03/input.txt":vn,"./advent/day04/input-test.txt":un,"./advent/day04/input.txt":hn,"./advent/day05/input-test.txt":an,"./advent/day05/input.txt":bn,"./advent/day06/input-test.txt":cn,"./advent/day06/input.txt":pn,"./advent/day07/input-test.txt":mn,"./advent/day07/input.txt":Tn,"./advent/day08/input-test.txt":xn,"./advent/day08/input-test2.txt":Kn,"./advent/day08/input-test3.txt":Qn,"./advent/day08/input.txt":kn,"./advent/day09/input-test.txt":jn,"./advent/day09/input.txt":Cn,"./advent/day10/input-test.txt":_n,"./advent/day10/input-test2.txt":zn,"./advent/day10/input.txt":qn,"./advent/day11/input-test.txt":Rn,"./advent/day11/input.txt":Gn,"./advent/day12/input-test.txt":Bn,"./advent/day12/input.txt":Sn,"./advent/day13/input-test.txt":Dn,"./advent/day13/input.txt":Mn,"./advent/day14/input-test.txt":An,"./advent/day14/input.txt":Hn,"./advent/day15/input-test.txt":Xn,"./advent/day15/input.txt":Vn,"./advent/day16/input-test.txt":Pn,"./advent/day16/input.txt":Nn,"./advent/day17/input-test.txt":wn,"./advent/day17/input.txt":yn,"./advent/day18/input-test.txt":On,"./advent/day18/input.txt":$n,"./advent/day19/input-test.txt":En,"./advent/day19/input.txt":Zn,"./advent/day20/input-test.txt":In,"./advent/day20/input.txt":Un,"./advent/day21/input-test.txt":Wn,"./advent/day21/input.txt":Yn,"./advent/day22/input-test.txt":n2,"./advent/day22/input.txt":e2,"./advent/day23/input-test.txt":J2,"./advent/day23/input.txt":L2,"./advent/day24/input-test.txt":F2,"./advent/day24/input.txt":r2,"./advent/day25/input-test.txt":t2,"./advent/day25/input.txt":s2});function P7(n,e,J,s){this.day=n||"01",this.input=J||"",this.testInputs=s||[""],this.part1=e.part1||null,this.part2=e.part2||null,this.knownAnswers=(e.knownAnswers||[]).map(F=>String(F))}function l2(){var n={},e={},J={};Object.keys(q7).forEach(L=>{var r=/day(\d+)/.exec(L)[1];n[r]=q7[L]||null}),Object.keys(p7).forEach(L=>{var r=/day(\d+)/.exec(L)[1];L.includes("test")?(J[r]=J[r]||[],J[r].push(p7[L]||"")):e[r]=p7[L]||""});var s={},F=Object.keys(n).sort();return F.forEach(L=>{var r=n[L]||{},t=e[L]||"",d=J[L]||[];s[L]=new P7(L,r,t,d)}),s}const d2=Object.freeze(Object.defineProperty({__proto__:null,DayData:P7,getDataByDay:l2},Symbol.toStringTag,{value:"Module"}));function R7(n,e,J){const s=n.slice();return s[28]=e[J],s[30]=J,s}function G7(n,e,J){const s=n.slice();return s[31]=e[J],s}function B7(n){let e,J=n[31]+"",s,F,L;function r(){return n[12](n[31])}return{c(){e=T("button"),s=l7(J),c(e,"class","button svelte-gd9guy"),V(e,"current",n[31]===n[2])},m(t,d){h7(t,e,d),v(e,s),F||(L=[H(e,"keydown",null),H(e,"click",r)],F=!0)},p(t,d){n=t,d[0]&2&&J!==(J=n[31]+"")&&m7(s,J),d[0]&6&&V(e,"current",n[31]===n[2])},d(t){t&&i7(e),F=!1,y(L)}}}function S7(n){let e,J,s;return{c(){e=T("button"),e.textContent="run all",c(e,"class","button run-all-button svelte-gd9guy")},m(F,L){h7(F,e,L),J||(s=[H(e,"keydown",null),H(e,"click",n[11])],J=!0)},p:L7,d(F){F&&i7(e),J=!1,y(s)}}}function D7(n){let e,J,s;function F(){return n[16](n[30])}return{c(){e=T("button"),e.textContent=`Test ${n[30]+1}`,c(e,"class","button input-toggle svelte-gd9guy"),V(e,"current",n[4]===n[30])},m(L,r){h7(L,e,r),J||(s=[H(e,"keydown",null),H(e,"click",F)],J=!0)},p(L,r){n=L,r[0]&16&&V(e,"current",n[4]===n[30])},d(L){L&&i7(e),J=!1,y(s)}}}function i2(n){let e,J,s,F,L,r,t,d,l,g,i,o,u,b=n[7][0]+"",p,Q,m,R,_,X,O,F7,$,E=n[7][1]+"",r7,g7,S,Z,o7,D,h,x,k,z,j,P,K,M,f7,I,t7,N,Q7,w,a7,k7,U=v7(n[1]),G=[];for(let f=0;f<U.length;f+=1)G[f]=B7(G7(n,U,f));let A=n[1].length>1&&S7(n),W=v7({length:n[3]}),B=[];for(let f=0;f<W.length;f+=1)B[f]=D7(R7(n,W,f));return{c(){e=T("div"),J=T("h2"),J.textContent="Advent 2023",s=q(),F=T("div"),L=T("div"),L.innerHTML='<h4 class="svelte-gd9guy">Days:</h4>',r=q(),t=T("div");for(let f=0;f<G.length;f+=1)G[f].c();d=q(),A&&A.c(),l=q(),g=T("div"),i=T("h4"),i.textContent="Part 1:",o=q(),u=T("div"),p=l7(b),Q=q(),m=T("textarea"),_=q(),X=T("div"),O=T("h4"),O.textContent="Part 2:",F7=q(),$=T("div"),r7=l7(E),g7=q(),S=T("textarea"),o7=q(),D=T("div"),h=T("h4"),h.textContent="Input:",x=q(),k=T("br"),z=q(),j=T("button"),j.textContent="Real",P=q();for(let f=0;f<B.length;f+=1)B[f].c();K=q(),M=T("textarea"),f7=q(),I=T("div"),t7=q(),N=T("div"),Q7=l7(`Catch errors
      `),w=T("button"),w.textContent="x",c(L,"class","label svelte-gd9guy"),c(t,"class","day-list"),c(i,"class","svelte-gd9guy"),c(u,"class","time svelte-gd9guy"),c(g,"class","label svelte-gd9guy"),c(m,"name","output1"),c(m,"id","output1"),c(m,"rows",R=u7(n[6][0])),c(m,"class","svelte-gd9guy"),V(m,"known-good",n[8][0]),c(O,"class","svelte-gd9guy"),c($,"class","time svelte-gd9guy"),c(X,"class","label svelte-gd9guy"),c(S,"name","output2"),c(S,"id","output2"),c(S,"rows",Z=u7(n[6][1])),c(S,"class","svelte-gd9guy"),V(S,"known-good",n[8][1]),c(h,"class","svelte-gd9guy"),c(j,"class","button input-toggle svelte-gd9guy"),V(j,"current",n[4]===-1),c(D,"class","label svelte-gd9guy"),E7(D,"align-self","flex-start"),c(M,"name","input"),c(M,"id","input"),c(M,"rows","14"),c(M,"class","svelte-gd9guy"),c(w,"class","button input-toggle catch-button svelte-gd9guy"),V(w,"current",n[5]),c(N,"class","catch-area svelte-gd9guy"),c(F,"class","layout svelte-gd9guy"),c(e,"class","outer svelte-gd9guy")},m(f,C){h7(f,e,C),v(e,J),v(e,s),v(e,F),v(F,L),v(F,r),v(F,t);for(let a=0;a<G.length;a+=1)G[a]&&G[a].m(t,null);v(t,d),A&&A.m(t,null),v(F,l),v(F,g),v(g,i),v(g,o),v(g,u),v(u,p),v(F,Q),v(F,m),Y(m,n[6][0]),v(F,_),v(F,X),v(X,O),v(X,F7),v(X,$),v($,r7),v(F,g7),v(F,S),Y(S,n[6][1]),v(F,o7),v(F,D),v(D,h),v(D,x),v(D,k),v(D,z),v(D,j),v(D,P);for(let a=0;a<B.length;a+=1)B[a]&&B[a].m(D,null);v(F,K),v(F,M),Y(M,n[0]),v(F,f7),v(F,I),v(F,t7),v(F,N),v(N,Q7),v(N,w),a7||(k7=[H(m,"input",n[13]),H(S,"input",n[14]),H(j,"keydown",null),H(j,"click",n[15]),H(M,"input",n[17]),H(w,"keydown",null),H(w,"click",n[18])],a7=!0)},p(f,C){if(C[0]&518){U=v7(f[1]);let a;for(a=0;a<U.length;a+=1){const s7=G7(f,U,a);G[a]?G[a].p(s7,C):(G[a]=B7(s7),G[a].c(),G[a].m(t,d))}for(;a<G.length;a+=1)G[a].d(1);G.length=U.length}if(f[1].length>1?A?A.p(f,C):(A=S7(f),A.c(),A.m(t,null)):A&&(A.d(1),A=null),C[0]&128&&b!==(b=f[7][0]+"")&&m7(p,b),C[0]&64&&R!==(R=u7(f[6][0]))&&c(m,"rows",R),C[0]&64&&Y(m,f[6][0]),C[0]&256&&V(m,"known-good",f[8][0]),C[0]&128&&E!==(E=f[7][1]+"")&&m7(r7,E),C[0]&64&&Z!==(Z=u7(f[6][1]))&&c(S,"rows",Z),C[0]&64&&Y(S,f[6][1]),C[0]&256&&V(S,"known-good",f[8][1]),C[0]&16&&V(j,"current",f[4]===-1),C[0]&1048){W=v7({length:f[3]});let a;for(a=0;a<W.length;a+=1){const s7=R7(f,W,a);B[a]?B[a].p(s7,C):(B[a]=D7(s7),B[a].c(),B[a].m(D,null))}for(;a<B.length;a+=1)B[a].d(1);B.length=W.length}C[0]&1&&Y(M,f[0]),C[0]&32&&V(w,"current",f[5])},i:L7,o:L7,d(f){f&&i7(e),C7(G,f),A&&A.d(),C7(B,f),a7=!1,y(k7)}}}function u7(n){var e=String(n||"").split(`
`).length;return Math.min(e,Math.max(e,1,10))}function g2(n,e,J){var s=h=>new Promise(x=>setTimeout(x,h)),F={},L=[],r="xx",t="",d=1,l=-1,g=!0,i=["",""],o=["",""],u=[!1,!1];function b(h=""){h&&J(2,r=h);var x=F[r];J(3,d=x.testInputs.length),l>d-1&&J(4,l=d-1),J(0,t=l<0?x?.input:x?.testInputs[l]),R()}function p(h=""){t&&R()}function Q(h=-1){J(4,l=h),b()}var m=!1;async function R(){if(!m){m=!0,J(6,i=["",""]),J(7,o=["",""]),await s(10);for(var h=1;h<=2;h++){var[x,k]=_(r,h,t),z=F7(r,h,x,l);X(h,x,k,z),await s(1)}m=!1}}function _(h="",x=1,k=""){var z=(F[h]||{})["part"+x];if(!z)return["",-999];var j=performance.now();if(g)try{return[z(k),performance.now()-j]}catch(M){var P=String(M),K=/:(\d+:\d+)\)/.exec(M.stack||"");return K&&(P=`(${K[1]}) ${P}`),[P,performance.now()-j]}else return[z(k),performance.now()-j]}function X(h=1,x="",k=0,z=!1){J(6,i[h-1]=x,i),J(7,o[h-1]=k<0?"":`(${Math.round(k)}ms)`,o),J(6,i),J(7,o),J(8,u[h-1]=z,u),J(8,u)}async function O(){var N;if(!m){m=!0;var h=["",""],x=[0,0],k=[!0,!0];J(4,l=-1),J(0,t=""),await s(10);for(var z=0;z<L.length;z++)for(var j=L[z],P=F[j],K=1;K<3;K++){var M=P?.input,[f7,I]=_(j,K,M||""),t7=I>=0&&F7(j,K,f7);k[N=K-1]&&(k[N]=t7),h[K-1]+=t7?"★":"ー",I>=0&&(x[K-1]+=I),X(K,h[K-1],x[K-1],k[K-1]),await s(1)}J(8,u=k),m=!1}}function F7(h="",x=1,k="",z=-1){var j=F[h]?.knownAnswers||[],P=2+2*z+(x===1?0:1),K=String(j[P]||"");return!!(K&&K===String(k))}var $=h=>{!h||!h.getDataByDay||(F=h.getDataByDay(),J(1,L=Object.keys(F).filter(x=>!!F[x].part1).sort()),b(L.at(-1)))};$(d2);const E=h=>b(h);function r7(){i[0]=this.value,J(6,i)}function g7(){i[1]=this.value,J(6,i)}const S=()=>Q(-1),Z=h=>Q(h);function o7(){t=this.value,J(0,t)}const D=()=>{J(5,g=!g)};return n.$$.update=()=>{n.$$.dirty[0]&1&&p(t)},[t,L,r,d,l,g,i,o,u,b,Q,O,E,r7,g7,S,Z,o7,D]}class o2 extends r1{constructor(e){super(),F1(this,e,g2,i2,y7,{},null,[-1,-1])}}new o2({target:document.querySelector(".app")});
