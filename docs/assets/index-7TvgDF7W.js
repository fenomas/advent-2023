var r1=Object.defineProperty;var t1=(n,e,r)=>e in n?r1(n,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):n[e]=r;var un=(n,e,r)=>(t1(n,typeof e!="symbol"?e+"":e,r),r);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))F(t);new MutationObserver(t=>{for(const J of t)if(J.type==="childList")for(const L of J.addedNodes)L.tagName==="LINK"&&L.rel==="modulepreload"&&F(L)}).observe(document,{childList:!0,subtree:!0});function r(t){const J={};return t.integrity&&(J.integrity=t.integrity),t.referrerPolicy&&(J.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?J.credentials="include":t.crossOrigin==="anonymous"?J.credentials="omit":J.credentials="same-origin",J}function F(t){if(t.ep)return;t.ep=!0;const J=r(t);fetch(t.href,J)}})();function tn(){}function Hn(n){return n()}function Cn(){return Object.create(null)}function N(n){n.forEach(Hn)}function Vn(n){return typeof n=="function"}function J1(n,e){return n!=n?e==e:n!==e||n&&typeof n=="object"||typeof n=="function"}function L1(n){return Object.keys(n).length===0}function i(n,e){n.appendChild(e)}function cn(n,e,r){n.insertBefore(e,r||null)}function fn(n){n.parentNode&&n.parentNode.removeChild(n)}function _n(n,e){for(let r=0;r<n.length;r+=1)n[r]&&n[r].d(e)}function z(n){return document.createElement(n)}function ln(n){return document.createTextNode(n)}function C(){return ln(" ")}function D(n,e,r,F){return n.addEventListener(e,r,F),()=>n.removeEventListener(e,r,F)}function u(n,e,r){r==null?n.removeAttribute(e):n.getAttribute(e)!==r&&n.setAttribute(e,r)}function F1(n){return Array.from(n.childNodes)}function xn(n,e){e=""+e,n.data!==e&&(n.data=e)}function Y(n,e){n.value=e??""}function s1(n,e,r,F){r==null?n.style.removeProperty(e):n.style.setProperty(e,r,F?"important":"")}function H(n,e,r){n.classList.toggle(e,!!r)}let Tn;function dn(n){Tn=n}const en=[],Rn=[];let rn=[];const Gn=[],l1=Promise.resolve();let kn=!1;function d1(){kn||(kn=!0,l1.then(Xn))}function jn(n){rn.push(n)}const an=new Set;let nn=0;function Xn(){if(nn!==0)return;const n=Tn;do{try{for(;nn<en.length;){const e=en[nn];nn++,dn(e),f1(e.$$)}}catch(e){throw en.length=0,nn=0,e}for(dn(null),en.length=0,nn=0;Rn.length;)Rn.pop()();for(let e=0;e<rn.length;e+=1){const r=rn[e];an.has(r)||(an.add(r),r())}rn.length=0}while(en.length);for(;Gn.length;)Gn.pop()();kn=!1,an.clear(),dn(n)}function f1(n){if(n.fragment!==null){n.update(),N(n.before_update);const e=n.dirty;n.dirty=[-1],n.fragment&&n.fragment.p(n.ctx,e),n.after_update.forEach(jn)}}function v1(n){const e=[],r=[];rn.forEach(F=>n.indexOf(F)===-1?e.push(F):r.push(F)),r.forEach(F=>F()),rn=e}const g1=new Set;function O1(n,e){n&&n.i&&(g1.delete(n),n.i(e))}function hn(n){return n?.length!==void 0?n:Array.from(n)}function h1(n,e,r){const{fragment:F,after_update:t}=n.$$;F&&F.m(e,r),jn(()=>{const J=n.$$.on_mount.map(Hn).filter(Vn);n.$$.on_destroy?n.$$.on_destroy.push(...J):N(J),n.$$.on_mount=[]}),t.forEach(jn)}function b1(n,e){const r=n.$$;r.fragment!==null&&(v1(r.after_update),N(r.on_destroy),r.fragment&&r.fragment.d(e),r.on_destroy=r.fragment=null,r.ctx=[])}function o1(n,e){n.$$.dirty[0]===-1&&(en.push(n),d1(),n.$$.dirty.fill(0)),n.$$.dirty[e/31|0]|=1<<e%31}function i1(n,e,r,F,t,J,L=null,s=[-1]){const d=Tn;dn(n);const l=n.$$={fragment:null,ctx:[],props:J,update:tn,not_equal:t,bound:Cn(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(d?d.$$.context:[])),callbacks:Cn(),dirty:s,skip_bound:!1,root:e.target||d.$$.root};L&&L(l.root);let v=!1;if(l.ctx=r?r(n,e.props||{},(g,f,...h)=>{const b=h.length?h[0]:f;return l.ctx&&t(l.ctx[g],l.ctx[g]=b)&&(!l.skip_bound&&l.bound[g]&&l.bound[g](b),v&&o1(n,g)),f}):[],l.update(),v=!0,N(l.before_update),l.fragment=F?F(l.ctx):!1,e.target){if(e.hydrate){const g=F1(e.target);l.fragment&&l.fragment.l(g),g.forEach(fn)}else l.fragment&&l.fragment.c();e.intro&&O1(n.$$.fragment),h1(n,e.target,e.anchor),Xn()}dn(d)}class p1{constructor(){un(this,"$$");un(this,"$$set")}$destroy(){b1(this,1),this.$destroy=tn}$on(e,r){if(!Vn(r))return tn;const F=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return F.push(r),()=>{const t=F.indexOf(r);t!==-1&&F.splice(t,1)}}$set(e){this.$$set&&!L1(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}const c1="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(c1);var m1=[54304,54418,142,,,281];function u1(n=""){return n.split(/\n/).reduce((e,r)=>{var F=r.split("").filter(t=>/\d/.test(t));return e+parseInt(F[0]+F.at(-1))||0},0)}function a1(n=""){var e=[..."0123456789".split(""),"zero","one","two","three","four","five","six","seven","eight","nine"];return n.split(/\n/).reduce((r,F)=>{var t=-1,J=1/0,L=-1,s=-1;return e.forEach((d,l)=>{var v=F.indexOf(d);v>-1&&v<J&&(J=v,t=l%10);var g=F.lastIndexOf(d);g>-1&&g>s&&(s=g,L=l%10)}),r+parseInt(t+""+L)},0)}const z1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:m1,part1:u1,part2:a1},Symbol.toStringTag,{value:"Module"}));var x1=[2727,56580,8,2286];function k1(n=""){var e=0,r={red:12,green:13,blue:14};return n.split(`
`).forEach(F=>{var[t,J]=F.split(":"),L=J.split(";").every(s=>s.split(",").every(d=>{var[,l,v]=/(\d+)\s+(\S+)/.exec(d);return r[v]?parseInt(l)<=r[v]:!0}));L&&(e+=parseInt(/\d+/.exec(t)[0]))}),e}function j1(n=""){var e=0;return n.split(`
`).forEach(r=>{var F={red:0,green:0,blue:0},[,t]=r.split(":");t.split(";").forEach(J=>{J.split(",").forEach(L=>{var[,s,d]=/(\d+)\s+(\S+)/.exec(L),l=parseInt(s);l>F[d]&&(F[d]=l)})}),e+=F.red*F.green*F.blue}),e}const q1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:x1,part1:k1,part2:j1},Symbol.toStringTag,{value:"Module"}));var T1=[539637,82818007,4361,467835];function K1(n=""){var e=[],r=[];n.split(`
`).forEach((t,J)=>{e[J]=[],r[J]=[];for(var L=0;L<t.length;L++){var s=t[L];if(s!==".")if(/\d/.test(s)){var d=parseInt(t.substring(L)),l=String(d).length;e[J].push({y:J,x:L,value:d,len:l}),L+=l-1}else r[J].push({y:J,x:L})}});var F=0;return e.forEach(t=>{t.forEach(J=>{for(var L=J.y-1;L<J.y+2;L++){var s=r[L]||[],d=s.some(l=>{if(!(l.x<J.x-1)&&!(l.x>J.x+J.len))return!0});if(d){F+=J.value;return}}})}),F}function Q1(n=""){var e=[],r=[];n.split(`
`).forEach((t,J)=>{e[J]=[],r[J]=[];for(var L=0;L<t.length;L++){var s=t[L];if(s!==".")if(/\d/.test(s)){var d=parseInt(t.substring(L)),l=String(d).length;e[J].push({y:J,x:L,value:d,len:l}),L+=l-1}else s==="*"&&r[J].push({y:J,x:L})}});var F=0;return r.forEach(t=>{t.forEach(J=>{for(var L=0,s=1,d=J.y-1;d<J.y+2;d++){var l=e[d]||[];l.forEach(v=>{J.x<v.x-1||J.x>v.x+v.len||(L++,s*=v.value)})}L===2&&(F+=s)})}),F}const C1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:T1,part1:K1,part2:Q1},Symbol.toStringTag,{value:"Module"}));var _1=[26443,6284877,13,30];function R1(n=""){var e=0;return n.split(`
`).forEach((r,F)=>{var t=r.split(":")[1].split("|"),J=t[0].trim().split(/\s+/).map(d=>parseInt(d)),L=t[1].trim().split(/\s+/).map(d=>parseInt(d)),s=L.reduce((d,l)=>d+(J.includes(l)?1:0),0);s>0&&(e+=Math.pow(2,s-1))}),e}function G1(n=""){var e=n.split(`
`).map((t,J)=>{var L=t.split(":")[1].split("|"),s=L[0].trim().split(/\s+/).map(v=>parseInt(v)),d=L[1].trim().split(/\s+/).map(v=>parseInt(v)),l=d.reduce((v,g)=>v+(s.includes(g)?1:0),0);return l>0&&(r+=Math.pow(2,l-1)),l}),r=0,F=[];return e.forEach((t,J)=>{for(var L=1+(F[J]||0),s=e[J],d=0;d<s;d++){var l=J+1+d;F[l]=(F[l]||0)+L}r+=L}),r}const B1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:_1,part1:R1,part2:G1},Symbol.toStringTag,{value:"Module"}));var A1=[525792406,79004094,35,46];function S1(n=""){var e=[],r=null;n.split(`
`).forEach((t,J)=>{if(/:/.test(t)){var[,L]=t.split(":");e.push(r=[]),t=L}var s=t.trim().split(/\s+/).filter(d=>d).map(d=>parseInt(d));s.length>0&&r.push(s)});var F=e.shift()[0];return e.forEach(t=>{var J={};t.forEach(([L,s,d])=>{F.forEach((l,v)=>{J[v]||l>=s&&l<s+d&&(F[v]+=L-s,J[v]=!0)})})}),F.reduce((t,J)=>Math.min(t,J),1/0)}function M1(n=""){var e,r=[],F;n.split(`
`).forEach((s,d)=>{if(/:/.test(s)){var[,l]=s.split(":");if(!e){e=l.trim().split(/\s+/).map(h=>parseInt(h));return}r.push(F=[]),s=l}if(s=s.trim(),!!s){var[v,g,f]=s.split(/\s+/).map(h=>parseInt(h));F.push([g,g+f,v-g])}}),r.forEach(s=>{s.sort((d,l)=>d[0]-l[0])});for(var t=1/0,J=(s,d,l=0)=>{if(l>=r.length){s<t&&(t=s);return}var v=r[l];v.some(([g,f,h])=>{if(!(s>=f)){if(d<=g)return!0;s<g&&(J(s,g,l+1),s=g);var b=Math.min(d,f);J(s+h,b+h,l+1),s=b}}),s<d&&J(s,d,l+1)},L=0;L<e.length;L+=2)J(e[L],e[L]+e[L+1]);return t}const D1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:A1,part1:S1,part2:M1},Symbol.toStringTag,{value:"Module"}));var w1=[1195150,42550411,288,71503];function Pn(n=""){var e=n.split(`
`).map(J=>{var L=J.split(":")[1];return L.trim().split(/\s+/).map(s=>parseInt(s))}),[r,F]=e,t=1;return r.forEach((J,L)=>{var s=-J,d=F[L],l=Math.sqrt(s*s-4*d),v=(-s-l)/2,g=(-s+l)/2,f=1e-5,h=Math.floor(g-f)-Math.ceil(v+f)+1;t*=h}),t}function H1(n=""){return Pn(n.replace(/ /g,""))}const V1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:w1,part1:Pn,part2:H1},Symbol.toStringTag,{value:"Module"}));var X1=[249726565,251135960,6440,5905];function P1(n=""){var e="23456789TJQKA".split(""),r={};e.forEach((t,J)=>{r[t]=String.fromCharCode(65+J)});var F=n.split(`
`).map(t=>{var[J,L]=t.trim().split(/\s+/),s=parseInt(L),d=J.split("").map(g=>r[g]),l={};d.forEach(g=>{l[g]=(l[g]||0)+1});var v=Object.keys(l).map(g=>l[g]).sort((g,f)=>f-g);return v.push(0,0),{chars:d,bid:s,ctList:v}});return F.sort((t,J)=>{for(var L=0;L<2;L++)if(t.ctList[L]!==J.ctList[L])return t.ctList[L]-J.ctList[L];for(var s=0;s<5;s++){var d=t.chars[s],l=J.chars[s];if(d!==l)return d>l?1:-1}return 0}),F.reduce((t,{bid:J},L)=>t+J*(L+1),0)}function N1(n=""){var e="J23456789TQKA".split(""),r={};e.forEach((t,J)=>{r[t]=String.fromCharCode(65+J)});var F=n.split(`
`).map(t=>{var[J,L]=t.trim().split(/\s+/),s=parseInt(L),d=J.split("").map(f=>r[f]),l={},v=0;d.forEach(f=>{if(f==="A"){v++;return}l[f]=(l[f]||0)+1});var g=Object.keys(l).map(f=>l[f]).sort((f,h)=>h-f);return g.push(0,0),g[0]+=v,{chars:d,bid:s,ctList:g,hand:J}});return F.sort((t,J)=>{for(var L=0;L<2;L++)if(t.ctList[L]!==J.ctList[L])return t.ctList[L]-J.ctList[L];for(var s=0;s<5;s++){var d=t.chars[s],l=J.chars[s];if(d!==l)return d>l?1:-1}return 0}),F.reduce((t,{bid:J},L)=>t+J*(L+1),0)}const y1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:X1,part1:P1,part2:N1},Symbol.toStringTag,{value:"Module"}));var $1=[18673,17972669116327,2,,6,,,6];function E1(n=""){var e={},r=n.split(`
`).map(s=>{if(s=s.trim(),!!s){if(!s.includes("="))return s.split("");var[,d,l,v]=/(\S+) = \((\S+), (\S+)\)/.exec(s);e[d]={L:l,R:v}}}),F=r.shift(),t="AAA";if(!e[t])return-1;for(var J=0,L=0;J<1e7;J++){if(t==="ZZZ")return J;t=e[t][F[L]],L=(L+1)%F.length}return-1}function Z1(n=""){var e={},r=[],F={},t=n.split(`
`).map(v=>{if(v=v.trim(),!!v){if(!v.includes("="))return v.split("");var[,g,f,h]=/(\S+) = \((\S+), (\S+)\)/.exec(v);/..A/.test(g)&&r.push(g),/..Z/.test(g)&&(F[g]=!0),e[g]={L:f,R:h}}}),J=t.shift(),L=r.map(v=>{for(var g=0,f=0;g<1e7;g++){if(v in F)return g;v=e[v][J[f]],f=(f+1)%J.length}});L.sort((v,g)=>v-g);for(var s=L.pop();L.length>0;)for(var d=s,l=L.pop();s%l!==0;)s+=d;return s}const I1=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:$1,part1:E1,part2:Z1},Symbol.toStringTag,{value:"Module"}));var U1=[1772145754,867,114,2];function W1(n=""){var e=(r=[1,1])=>{if(r.length<2)return NaN;for(var F=!0,t=[],J=1;J<r.length;J++){var L=r[J]-r[J-1];F&&(F=L===0),t.push(L)}var s=F?0:e(t);return s+r.at(-1)};return n.split(`
`).reduce((r,F)=>{var t=F.trim().split(/\s+/).map(J=>parseInt(J));return r+=e(t)},0)}function Y1(n=""){var e=(r=[1,1])=>{if(r.length<2)return NaN;for(var F=!0,t=[],J=1;J<r.length;J++){var L=r[J]-r[J-1];F&&(F=L===0),t.push(L)}var s=F?0:e(t);return r[0]-s};return n.split(`
`).reduce((r,F)=>{var t=F.trim().split(/\s+/).map(J=>parseInt(J));return r+=e(t)},0)}const n7=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:U1,part1:W1,part2:Y1},Symbol.toStringTag,{value:"Module"}));var e7=[6757,523,8,,,10];function Nn(n=""){var e=[],r=[0,0];n.split(`
`).forEach((d,l)=>{e[l]=[],d.trim().split("").forEach((v,g)=>{v==="S"&&(r=[l,g]),e[l].push({x:g,y:l,char:v})})},0);var F=e.length,t=e[0].length,J=(d,l)=>d<0||d>=F||l<0||l>=t?null:e[d][l],L=J(...r),s=(d,l,v)=>{var g=J(d,l);if(g)for(var f=[g],h=0,b=(O,a,_)=>{var K=J(O,a);K&&v(m,K,_)&&f.push(K)};f.length>0&&h++<1e6;){var m=f.pop();b(m.y-1,m.x,0),b(m.y+1,m.x,2),b(m.y,m.x+1,1),b(m.y,m.x-1,3)}};return{start:L,sx:t,sy:F,getAt:J,flood:s}}function r7(n=""){var{start:e,sx:r,sy:F,getAt:t,flood:J}=Nn(n),L={"|":[0,2],"-":[1,3],L:[0,1],J:[0,3],7:[2,3],F:[1,2],S:[0,1,2,3]},s=0;return J(e.y,e.x,(d,l,v)=>{if(d.seen=!0,l.seen)return!1;var g=L[d.char]||[];if(!g.includes(v))return!1;var f=L[l.char]||[],h=(v+2)%4;return f.includes(h)?(s++,!0):!1}),s/2}function t7(n=""){var{start:e,sx:r,sy:F,getAt:t,flood:J}=Nn(n),L={"|":[0,2],"-":[1,3],L:[0,1],J:[0,3],7:[2,3],F:[1,2],S:[0,1,2,3]},s=[],d=[],l=(f,h,b,m)=>{b%2===0&&(f+=b-1),b%2===1&&(h+=2-b);var O=t(f,h);O&&!O.seen&&m.push(O)};J(e.y,e.x,(f,h,b)=>{if(f.seen=!0,h.seen)return!1;var m=L[f.char]||[];if(!m.includes(b))return!1;var O=L[h.char]||[];if(!O.includes((b+2)%4))return!1;if(f===e)return!0;for(var a=m[(m.indexOf(b)+1)%2],_=d,K=1;K<4;K++){var w=(b+K)%4;if(w===a){_=s;continue}l(f.y,f.x,w,_)}return!0});var v=f=>{var h=0,b=!1;return f.forEach(m=>{m.seen||J(m.y,m.x,(O,a)=>{if(O.seen)return!1;O.seen=!0,h++;var{y:_,x:K}=O;return(K===0||K===r-1)&&(b=!0),(_===0||_===F-1)&&(b=!0),!a.seen})}),{ct:h,borderSeen:b}},g=v(s);return g.borderSeen&&(g=v(d)),g.ct}const J7=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:e7,part1:r7,part2:t7},Symbol.toStringTag,{value:"Module"}));var L7=[9623138,726820169514,374,82000210];function yn(n=""){var e=[],r=[],F=[];n.split(`
`).forEach((s,d)=>{if(s=s.trim(),!!s){e.length===0&&(e.length=s.length,e.fill(!0)),r[d]=!0;for(var l=-1;l=s.indexOf("#",l),!(l<0);)e[l]=!1,r[d]=!1,F.push({x:l,y:d}),l++}});var t=0,J=e.map(s=>s?++t:t);t=0;var L=r.map(s=>s?++t:t);return F.forEach(s=>{s.emptyLeft=J[s.x],s.emptyAbove=L[s.y]}),{locs:F}}function F7(n=""){for(var{locs:e}=yn(n),r=(L,s)=>{var d=e[L],l=e[s],v=Math.abs(d.x-l.x),g=Math.abs(d.y-l.y),f=Math.abs(d.emptyLeft-l.emptyLeft),h=Math.abs(d.emptyAbove-l.emptyAbove);return v+g+f+h},F=0,t=0;t<e.length;t++)for(var J=t+1;J<e.length;J++)F+=r(t,J);return F}function s7(n=""){for(var{locs:e}=yn(n),r=999999,F=(s,d)=>{var l=e[s],v=e[d],g=Math.abs(l.x-v.x),f=Math.abs(l.y-v.y),h=Math.abs(l.emptyLeft-v.emptyLeft)*r,b=Math.abs(l.emptyAbove-v.emptyAbove)*r;return g+f+h+b},t=0,J=0;J<e.length;J++)for(var L=J+1;L<e.length;L++)t+=F(J,L);return t}const l7=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:L7,part1:F7,part2:s7},Symbol.toStringTag,{value:"Module"}));var d7=[7379,7732028747925,21,525152];function f7(n=""){var e=(r="",F=0,t=0,J=[1])=>{if(F>r.length-1)return t===0?1:0;if(t>r.length-F)return 0;if(t===0)return r.substring(F).includes("#")?0:1;if(r[F]===".")return e(r,F+1,t,J);var L=0;r[F]==="?"&&(L+=e(r,F+1,t,J));var s=J[0];if(r.substring(F,F+s).includes(".")||r[F+s]==="#")return L;var d=J.filter((v,g)=>g>0),l=t-s-(J.length>1?1:0);return L+e(r,F+s+1,l,d)};return n.split(`
`).reduce((r,F)=>{if(F=F.trim(),!F)return r;var[t,J]=F.split(/\s+/),L=t.split(/\.+/).join("."),s=J.split(",").map(l=>parseInt(l)),d=s.reduce((l,v)=>l+v)+s.length-1;return r+e(L,0,d,s)},0)}function v7(n=""){var e=(t,J,L,s)=>{for(;L<s;)if(t[L++]===J)return!0},r=t=>{var J={};return(L,s,d)=>{var l=(L<<12)+s;return l in J?J[l]:J[l]=t(L,s,d)}},F=(t="")=>{var J=(L=0,s=0,d=[1])=>{if(L>t.length-1)return s===0?1:0;if(s>t.length-L)return 0;if(s===0)return e(t,"#",L,t.length)?0:1;if(t[L]===".")return J(L+1,s,d);var l=0;t[L]==="?"&&(l+=J(L+1,s,d));var v=d[0];if(e(t,".",L,L+v)||t[L+v]==="#")return l;var g=d.filter((h,b)=>b>0),f=s-v-(d.length>1?1:0);return l+J(L+v+1,f,g)};return J=r(J),J};return n.split(`
`).reduce((t,J)=>{if(J=J.trim(),!J)return t;var[L,s]=J.split(/\s+/),d=L.split(/\.+/).join("."),l=s.split(",").map(f=>parseInt(f)),v=5;d=[...Array(v).fill(d)].join("?"),l=[].concat(...Array(v).fill(l));var g=l.reduce((f,h)=>f+h)+l.length-1;return t+F(d)(0,g,l)},0)}const g7=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:d7,part1:f7,part2:v7},Symbol.toStringTag,{value:"Module"}));var O7=[35210,31974,405,400],$n=(n=[""],e=0,r=1)=>{for(var F=0;e>=0&&r<n.length;e--,r++)if(n[e]!==n[r]){for(var t=0;t<n[0].length;t++)if(n[e][t]!==n[r][t]&&(F++,F>1))return 2}return F},En=(n=[""],e=0,r=1)=>{for(var F=0;e>=0&&r<n[0].length;e--,r++)for(var t=0;t<n.length;t++)if(n[t][e]!==n[t][r]&&(F++,F>1))return 2;return F};function h7(n=""){return n.split(`

`).reduce((e,r)=>{for(var F=r.split(`
`).map(s=>s.trim()),t=1;t<F.length;t++){var J=$n(F,t-1,t);if(!(J>0))return e+t*100}for(var L=1;L<F[0].length;L++){var J=En(F,L-1,L);if(!(J>0))return e+L}throw"?"},0)}function b7(n=""){return n.split(`

`).reduce((e,r)=>{for(var F=r.split(`
`).map(s=>s.trim()),t=1;t<F.length;t++){var J=$n(F,t-1,t);if(J===1)return e+t*100}for(var L=1;L<F[0].length;L++){var J=En(F,L-1,L);if(J===1)return e+L}throw"?"},0)}const o7=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:O7,part1:h7,part2:b7},Symbol.toStringTag,{value:"Module"}));function i7(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}function p7(n){for(var e=new Array(n),r=0;r<n;++r)e[r]=r;return e}var c7=p7;/*!
 * Determine if an object is a Buffer
 *
 * @author   Feross Aboukhadijeh <https://feross.org>
 * @license  MIT
 */var m7=function(n){return n!=null&&(Zn(n)||u7(n)||!!n._isBuffer)};function Zn(n){return!!n.constructor&&typeof n.constructor.isBuffer=="function"&&n.constructor.isBuffer(n)}function u7(n){return typeof n.readFloatLE=="function"&&typeof n.slice=="function"&&Zn(n.slice(0,0))}var a7=c7,z7=m7,x7=typeof Float64Array<"u";function k7(n,e){return n[0]-e[0]}function j7(){var n=this.stride,e=new Array(n.length),r;for(r=0;r<e.length;++r)e[r]=[Math.abs(n[r]),r];e.sort(k7);var F=new Array(e.length);for(r=0;r<F.length;++r)F[r]=e[r][1];return F}function q7(n,e){var r=["View",e,"d",n].join("");e<0&&(r="View_Nil"+n);var F=n==="generic";if(e===-1){var t="function "+r+"(a){this.data=a;};var proto="+r+".prototype;proto.dtype='"+n+"';proto.index=function(){return -1};proto.size=0;proto.dimension=-1;proto.shape=proto.stride=proto.order=[];proto.lo=proto.hi=proto.transpose=proto.step=function(){return new "+r+"(this.data);};proto.get=proto.set=function(){};proto.pick=function(){return null};return function construct_"+r+"(a){return new "+r+"(a);}",m=new Function(t);return m()}else if(e===0){var t="function "+r+"(a,d) {this.data = a;this.offset = d};var proto="+r+".prototype;proto.dtype='"+n+"';proto.index=function(){return this.offset};proto.dimension=0;proto.size=1;proto.shape=proto.stride=proto.order=[];proto.lo=proto.hi=proto.transpose=proto.step=function "+r+"_copy() {return new "+r+"(this.data,this.offset)};proto.pick=function "+r+"_pick(){return TrivialArray(this.data);};proto.valueOf=proto.get=function "+r+"_get(){return "+(F?"this.data.get(this.offset)":"this.data[this.offset]")+"};proto.set=function "+r+"_set(v){return "+(F?"this.data.set(this.offset,v)":"this.data[this.offset]=v")+"};return function construct_"+r+"(a,b,c,d){return new "+r+"(a,d)}",m=new Function("TrivialArray",t);return m(on[n][0])}var t=["'use strict'"],J=a7(e),L=J.map(function(O){return"i"+O}),s="this.offset+"+J.map(function(O){return"this.stride["+O+"]*i"+O}).join("+"),d=J.map(function(O){return"b"+O}).join(","),l=J.map(function(O){return"c"+O}).join(",");t.push("function "+r+"(a,"+d+","+l+",d){this.data=a","this.shape=["+d+"]","this.stride=["+l+"]","this.offset=d|0}","var proto="+r+".prototype","proto.dtype='"+n+"'","proto.dimension="+e),t.push("Object.defineProperty(proto,'size',{get:function "+r+"_size(){return "+J.map(function(O){return"this.shape["+O+"]"}).join("*"),"}})"),e===1?t.push("proto.order=[0]"):(t.push("Object.defineProperty(proto,'order',{get:"),e<4?(t.push("function "+r+"_order(){"),e===2?t.push("return (Math.abs(this.stride[0])>Math.abs(this.stride[1]))?[1,0]:[0,1]}})"):e===3&&t.push("var s0=Math.abs(this.stride[0]),s1=Math.abs(this.stride[1]),s2=Math.abs(this.stride[2]);if(s0>s1){if(s1>s2){return [2,1,0];}else if(s0>s2){return [1,2,0];}else{return [1,0,2];}}else if(s0>s2){return [2,0,1];}else if(s2>s1){return [0,1,2];}else{return [0,2,1];}}})")):t.push("ORDER})")),t.push("proto.set=function "+r+"_set("+L.join(",")+",v){"),F?t.push("return this.data.set("+s+",v)}"):t.push("return this.data["+s+"]=v}"),t.push("proto.get=function "+r+"_get("+L.join(",")+"){"),F?t.push("return this.data.get("+s+")}"):t.push("return this.data["+s+"]}"),t.push("proto.index=function "+r+"_index(",L.join(),"){return "+s+"}"),t.push("proto.hi=function "+r+"_hi("+L.join(",")+"){return new "+r+"(this.data,"+J.map(function(O){return["(typeof i",O,"!=='number'||i",O,"<0)?this.shape[",O,"]:i",O,"|0"].join("")}).join(",")+","+J.map(function(O){return"this.stride["+O+"]"}).join(",")+",this.offset)}");var v=J.map(function(O){return"a"+O+"=this.shape["+O+"]"}),g=J.map(function(O){return"c"+O+"=this.stride["+O+"]"});t.push("proto.lo=function "+r+"_lo("+L.join(",")+"){var b=this.offset,d=0,"+v.join(",")+","+g.join(","));for(var f=0;f<e;++f)t.push("if(typeof i"+f+"==='number'&&i"+f+">=0){d=i"+f+"|0;b+=c"+f+"*d;a"+f+"-=d}");t.push("return new "+r+"(this.data,"+J.map(function(O){return"a"+O}).join(",")+","+J.map(function(O){return"c"+O}).join(",")+",b)}"),t.push("proto.step=function "+r+"_step("+L.join(",")+"){var "+J.map(function(O){return"a"+O+"=this.shape["+O+"]"}).join(",")+","+J.map(function(O){return"b"+O+"=this.stride["+O+"]"}).join(",")+",c=this.offset,d=0,ceil=Math.ceil");for(var f=0;f<e;++f)t.push("if(typeof i"+f+"==='number'){d=i"+f+"|0;if(d<0){c+=b"+f+"*(a"+f+"-1);a"+f+"=ceil(-a"+f+"/d)}else{a"+f+"=ceil(a"+f+"/d)}b"+f+"*=d}");t.push("return new "+r+"(this.data,"+J.map(function(O){return"a"+O}).join(",")+","+J.map(function(O){return"b"+O}).join(",")+",c)}");for(var h=new Array(e),b=new Array(e),f=0;f<e;++f)h[f]="a[i"+f+"]",b[f]="b[i"+f+"]";t.push("proto.transpose=function "+r+"_transpose("+L+"){"+L.map(function(O,a){return O+"=("+O+"===undefined?"+a+":"+O+"|0)"}).join(";"),"var a=this.shape,b=this.stride;return new "+r+"(this.data,"+h.join(",")+","+b.join(",")+",this.offset)}"),t.push("proto.pick=function "+r+"_pick("+L+"){var a=[],b=[],c=this.offset");for(var f=0;f<e;++f)t.push("if(typeof i"+f+"==='number'&&i"+f+">=0){c=(c+this.stride["+f+"]*i"+f+")|0}else{a.push(this.shape["+f+"]);b.push(this.stride["+f+"])}");t.push("var ctor=CTOR_LIST[a.length+1];return ctor(this.data,a,b,c)}"),t.push("return function construct_"+r+"(data,shape,stride,offset){return new "+r+"(data,"+J.map(function(O){return"shape["+O+"]"}).join(",")+","+J.map(function(O){return"stride["+O+"]"}).join(",")+",offset)}");var m=new Function("CTOR_LIST","ORDER",t.join(`
`));return m(on[n],j7)}function T7(n){if(z7(n))return"buffer";if(x7)switch(Object.prototype.toString.call(n)){case"[object Float64Array]":return"float64";case"[object Float32Array]":return"float32";case"[object Int8Array]":return"int8";case"[object Int16Array]":return"int16";case"[object Int32Array]":return"int32";case"[object Uint8Array]":return"uint8";case"[object Uint16Array]":return"uint16";case"[object Uint32Array]":return"uint32";case"[object Uint8ClampedArray]":return"uint8_clamped";case"[object BigInt64Array]":return"bigint64";case"[object BigUint64Array]":return"biguint64"}return Array.isArray(n)?"array":"generic"}var on={float32:[],float64:[],int8:[],int16:[],int32:[],uint8:[],uint16:[],uint32:[],array:[],uint8_clamped:[],bigint64:[],biguint64:[],buffer:[],generic:[]};function K7(n,e,r,F){if(n===void 0){var l=on.array[0];return l([])}else typeof n=="number"&&(n=[n]);e===void 0&&(e=[n.length]);var t=e.length;if(r===void 0){r=new Array(t);for(var J=t-1,L=1;J>=0;--J)r[J]=L,L*=e[J]}if(F===void 0){F=0;for(var J=0;J<t;++J)r[J]<0&&(F-=(e[J]-1)*r[J])}for(var s=T7(n),d=on[s];d.length<=t+1;)d.push(q7(s,d.length-1));var l=d[t+1];return l(n,e,r,F)}var Q7=K7;const In=i7(Q7);var C7=[108935,100876,136,64],qn=0,_7=1,pn=2,Un={".":qn,O:pn,"#":_7};function R7(n=""){var e=n.split(`
`).map(F=>F.trim()),r=In([],[e.length,e[0].length]);return e.forEach((F,t)=>{F.split("").forEach((J,L)=>{r.set(t,L,Un[J])})}),Wn(r),Yn(r).load}var Wn=n=>{for(var e=0;e<n.shape[0];e++)for(var r=0;r<n.shape[1];r++){var F=n.get(e,r);if(F===pn)for(var t=e;t>0&&n.get(t-1,r)===qn;)n.set(t,r,qn),n.set(--t,r,pn)}},Yn=n=>{for(var e=0,r=0,F=0,t=0;F<n.shape[0];F++,t++)for(var J=0;J<n.shape[1];J++)n.get(F,J)===pn&&(e+=n.shape[0]-F,r+=J*17+F*177+t*1777);return{load:e,hash:r}};function G7(n=""){var e=n.split(`
`).map(f=>f.trim()),r=In([],[e.length,e[0].length]);e.forEach((f,h)=>{f.split("").forEach((b,m)=>{r.set(h,m,Un[b])})});for(var F=[],t=[],J=0;J<1e4;J++){for(var L=0;L<4;L++)Wn(r),r=r.transpose(1,0).step(1,-1);var{load:s,hash:d}=Yn(r),l=t.indexOf(d)+1;if(l>0){var v=J+2,g=l+(1e9-v)%(v-l-1);return F[g]}F.push(s),t.push(d)}return-1}const B7=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:C7,part1:R7,part2:G7},Symbol.toStringTag,{value:"Module"}));var A7=[505459,228508,1320,145],n1=(n="")=>{for(var e=0,r=0;r<n.length;r++)e+=n.charCodeAt(r),e*=17,e%=256;return e};function S7(n=""){return n.split(`
`).join("").split(",").reduce((e,r)=>e+n1(r),0)}function M7(n=""){var e=Array(256).fill(1).map(r=>[]);return n.split(`
`).join("").split(",").forEach(r=>{var[,F,t]=/^(\w+)(.*)/.exec(r),J=n1(F),L=e[J];if(t==="-"){e[J]=L.filter(l=>l.label!==F);return}var s=parseInt(t.substring(1)),d=L.some((l,v)=>{if(l.label===F)return l.num=s,!0});d||L.push({label:F,num:s})}),e.reduce((r,F,t)=>r+F.reduce((J,L,s)=>J+(t+1)*(s+1)*L.num,0),0)}const D7=Object.freeze(Object.defineProperty({__proto__:null,knownAnswers:A7,part1:S7,part2:M7},Symbol.toStringTag,{value:"Module"})),w7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),H7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),V7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),X7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),P7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),N7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),y7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),$7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),E7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),Z7=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),I7=`1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet`,U7=`two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
zoneight234
7pqrstsixteen`,W7=`8eight1
98126
...
eight1eighteight8
8four419eighteight1bpv`,Y7=`Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`,n2=`Game 1: 3 blue, 2 green, 6 red; 17 green, 4 red, 8 blue; 2 red, 1 green, 10 blue; 1 blue, 5 green
...
Game 100: 8 blue, 6 green, 8 red; 7 red, 2 blue; 2 red, 10 green, 10 blue; 9 green, 7 red; 3 red, 7 green, 1 blue`,e2=`467..114..
...*......
..35..633.
......#...
617*......
...
......755.
...$.*....
.664.598..`,r2=`...............776..............552........968..................589...26...........484..............958......186....546.........484.........
.........*.........778....................*....124...................................*...............*........%..26.........................
...
...............764.....................................488.....880.209........416..................183...156..........917...................`,t2=`Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53
Card 2: 13 32 20 16 61 | 61 30 68 82 17 32 24 19
Card 3:  1 21 53 59 44 | 69 82 63 72 16 21 14  1
Card 4: 41 92 73 84 69 | 59 84 76 51 58  5 54 83
Card 5: 87 83 26 28 32 | 88 30 70 12 93 22 82 36
Card 6: 31 18 13 56 72 | 74 77 10 23 35 67 36 11`,J2=`Card   1: 79 93 21 74 81 76 17 89  3  5 |  5 67 87 81 76 35 79 21 15 80  8 74 99 28  3 23 19 42 89 16 22 77 92 70 34
...
Card 218: 68 97 66 41 88 16 65 31 23 63 | 29 67 55 64 91  4 12 83  1 40 74 94 58 81 98 82 78 70 26 34 96 14 36 50 56`,L2=`seeds: 79 14 55 13
...
60 56 37
56 93 4`,F2=`seeds: 28965817 302170009 1752849261 48290258 804904201 243492043 2150339939 385349830 1267802202 350474859 2566296746 17565716 3543571814 291402104 447111316 279196488 3227221259 47952959 1828835733 9607836
...
2446452559 2629702985 182296534`,s2=`Time:      7  15   30
Distance:  9  40  200`,l2=`Time:        54     94     65     92
Distance:   302   1476   1029   1404`,d2=`32T3K 765
T55J5 684
KK677 28
KTJJT 220
QQQJA 483`,f2=`88223 818
66JQ9 398
6T9AT 311
53TT3 43
J6266 762
...
22C = (22Z, 22Z)
22Z = (22B, 22B)
XXX = (XXX, XXX)`,h2=`
...
DBP = (RMQ, NMT)
SFT = (PRM, KLH)
CMD = (HFJ, QRF)`,b2=`0 3 6 9 12 15
1 3 6 10 15 21
10 13 16 21 30 45`,o2=`12 12 11 5 -5 -5 40 194 558 1278 2553 4643 7877 12661 19486 28936 41696 58560 80439 108369 143519
...
5 23 49 86 154 303 625 1278 2553 5048 10072 20498 42428 88236 181828 367312 722717 1380949 2560835 4611894 8077398`,i2=`7-F7-
.FJ|7
SJLL7
|F--J
LJ.LJ`,p2=`FF7FSF7F7F7F7F7F---7
L|LJ||||||||||||F--J
FL-7LJLJ||||||LJL-77
F--JF--7||LJLJ7F7FJ-
L---JF-JLJ.||-FJLJJ7
...
LJJ..LL-JJ-L---7J-F77LL.LFJJLL-J-7JJ.L-LL7-L7.LLJL|JJF7-J-JLLJLLJ-7LJJ..LLJ-LJJ.LFL-FJJL|.FLLF-FL|LL.J.FL|-JJ.JJL--JLL--JJ.|J-L|J--J.L7..JJJ`,m2=`...#......
.......#..
#.........
..........
......#...
...
.......O..
#....###..
#OO..#....`,q2=`...O.....#O#....O###...#..OOO.O#....#.O.O.....O...OO##.#..O.O...........O........#...#.#O........##.
